 ...
 */
 ...
 class CptController extends BaseController{
    ...
    public function setSettings(){
        ...
        $args =[ 
                    [
                        'option_group' => 'alecad_plugin_cpt_settings',
    ...
    public function storeCpt() { //Storing data for register a custom post type

        $options = !get_option( 'alecad_plugin_cpt' ) ? array() : get_option( 'alecad_plugin_cpt' );
    ...
    public function registerCpt(){//Callback for init
